...
remaining use of `cm_map[]` is now guarded, and the patch was complete for that bug class.
Bugs 1 to 3 are other unchecked attacker-controlled header values in the same file,
